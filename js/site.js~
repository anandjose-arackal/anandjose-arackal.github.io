...
MarkerLabel.prototype.onRemove = function() {
    ...
    for (var e = 0, t = this.listeners.length; t > e; ++e)
...
function() {
    ...
    n.addListener = function(e, i) {
        ...
        for (n in o)
            o.hasOwnProperty(n) && -1 === t(o[n], i) && o[n].push(s ? i : {
                listener: i,
                once: !1
            });
        return this
    ...
    n.manipulateListeners = function(e, t, i) {
        ...
        if ("object" != typeof t || t instanceof RegExp)
            ...
            for (n in t)
                t.hasOwnProperty(n) && (o = t[n]) && ("function" == typeof o ? s.call(this, n, o) : a.call(this, n, o));
        return this
    }
    ,
                    ...
                    for (var a = n.call(arguments, 1), r = 0, l = this.length; l > r; r++) {
                        ...
                        if (c)
                            if (e.isFunction(c[o]) && "_" !== o.charAt(0)) {
                                ...
                                s("no such method '" + o + "' for " + t + " instance");
                        else
                            s("cannot call methods on " + t + " prior to initialization; attempted to call '" + o + "'")
                    }
                    return this
                }
...
function(e, t) {
    ...
    function s(t) {
        ...
        function l(t, i) {
            if (e.getComputedStyle || -1 === i.indexOf("%"))
                return i;
            var n = t.style
              , o = n.left
              , s = t.runtimeStyle
...
function(e) {
    ...
    function o(o) {
        return "complete" === s.readyState ? n() : (o.bind(s, "DOMContentLoaded", i),
    ...
    n.filterFindElements = function(e, t) {
        ...
        for (var o = [], s = 0, a = e.length; a > s; s++) {
            ...
            if (n.isElement(r))
                if (t) {
                    i(r, t) && o.push(r);
                    for (var l = r.querySelectorAll(t), d = 0, c = l.length; c > d; d++)
                        o.push(l[d])
                } else
                    o.push(r)
        }
...
function(e, t) {
    ...
    a.prototype.ontransitionend = function(e) {
        if (e.target === this.element) {
            ...
            s(t.ingProperties) && this.disableTransition(),
...
function(e, t) {
    ...
    function a(e, t) {
        ...
        if (!i)
            return void (r && r.error("Bad element for " + this.constructor.namespace + ": " + (i || e)));
        this.element = i,
    ...
    a.prototype.getItemElements = function() {
        for (var e = [], t = 0, i = this.items.length; i > t; t++)
    ...
    a.prototype._getMeasurement = function(e, t) {
        ...
        s ? ("string" == typeof s ? i = this.element.querySelector(s) : o.isElement(s) && (i = s),
...
function(e, t) {
    ...
    n.prototype._getItemLayoutPosition = function(e) {
        ...
        for (var s = this._getColGroup(o), a = Math.min.apply(Math, s), r = i.indexOf(s, a), l = {
            ...
            y: a
        }, d = a + e.size.outerHeight, c = this.cols + 1 - s.length, u = 0; c > u; u++)
            this.colYs[r + u] = d;
        return l
    }
    ,
    ...
    n.prototype._manageStamp = function(e) {
        ...
        for (var l = (this.options.isOriginTop ? n.top : n.bottom) + i.outerHeight, d = a; r >= d; d++)
...
function(e, t) {
    ...
    h.prototype.updateSortData = function(e) {
        var t;
        e ? (e = o.makeArray(e),
        t = this.getItems(e)) : t = this.items,
        this._getSorters(),
    ...
    h.prototype.getFilteredItemElements = function() {
        for (var e = [], t = 0, i = this.filteredItems.length; i > t; t++)
    ...
    o.prototype = {
        ...
        getPositions: function() {
            ...
            o.$nav.each(function() {
                t = o.getHash(e(this)),
                n = e("#" + t),
                n.length && (i = n.offset().top,
                o.sections[t] = Math.round(i))
            })
        },
        ...
        scrollChange: function() {
            ...
            null  !== i && (e = this.$elem.find('a[href$="#' + i + '"]').parent(),
    ...
    e.fn.bxSlider = function(o) {
        ...
        var r = e(window).width()
          ...
          , c = function() {
            ...
            s.settings.ticker ? s.settings.pager = !1 : (s.settings.pager && S(),
          ...
          , v = function() {
            ...
            if (s.settings.moveSlides > 0)
                ...
                e = Math.ceil(s.children.length / g());
            return e
        }
          , y = function() {
          ...
          , w = function(e, t, i, n) {
            if (s.usingCSS) {
                ...
                a.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() {
                    ...
                    F()
                })) : "reset" == t ? a.css(s.animProp, o) : "ticker" == t && (a.css("-" + s.cssPrefix + "-transition-timing-function", "linear"),
                a.css(s.animProp, o),
                a.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() {
                    a.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"),
                ...
                var r = {};
                r[s.animProp] = e,
                "slide" == t ? a.animate(r, i, s.settings.easing, function() {
                    F()
          ...
          , x = function() {
            for (var t = "", i = v(), n = 0; i > n; n++) {
                var o = "";
                s.settings.buildPager && e.isFunction(s.settings.buildPager) ? (o = s.settings.buildPager(n),
                s.pagerEl.addClass("bx-custom-pager")) : (o = n + 1,
          ...
          , A = function() {
            1 == v() ? (s.controls.prev.addClass("disabled"),
            ...
            s.controls.next.removeClass("disabled")) : s.active.index == v() - 1 ? (s.controls.next.addClass("disabled"),
          ...
          , R = function(e) {
            ...
            if (3 * i > n && s.settings.preventDefaultSwipeX ? e.preventDefault() : 3 * n > i && s.settings.preventDefaultSwipeY && e.preventDefault(),
          ...
          , H = function(e) {
            ...
            "fade" == s.settings.mode) {
                ...
                n >= s.settings.swipeThreshold && (s.touch.start.x > s.touch.end.x ? a.goToNextSlide() : a.goToPrevSlide(),
                a.stopAuto())
            } else {
                var n = 0;
            ...
            if (!s.working && s.active.index != t)
                ...
                "fade" == s.settings.mode)
                    ...
                    if (!s.settings.infiniteLoop && s.carousel && s.active.last)
                        ...
                        o = a.find("> .bx-clone").eq(s.settings.maxSlides).position(),
                        s.active.last = !1;
                    else if (t >= 0) {
                        var c = t * y();
        ...
        a.startAuto = function(e) {
            ...
            s.settings.autoControls && 1 != e && L("stop"))
        }
        ,
        a.stopAuto = function(e) {
            s.interval && (clearInterval(s.interval),
            s.interval = null ,
            s.settings.autoControls && 1 != e && L("start"))
        }
        ,
        ...
        a.destroySlider = function() {
            ...
            s.settings.responsive && e(window).unbind("resize", N))
        }
        ,
...
!function(e) {
    ...
    !function(t) {
            ...
            update: function(t, i) {
                ...
                return e(o).each(function() {
                    ...
                    if (t.data(n)) {
                        ...
                        "y" === s.axis ? _.call(this) : "yx" === s.axis && o.overflowed[1] && Y(t, d[1].toString(), {
                            dir: "x",
                            dur: 0,
                            overwrite: "none"
                        }))),
                        ...
                        "x" === s.axis ? _.call(this) : "yx" === s.axis && o.overflowed[0] && Y(t, d[0].toString(), {
                            dir: "y",
                            dur: 0,
                            overwrite: "none"
                        }))),
                ...
                if ("undefined" != typeof t && null  != t) {
                    ...
                    return e(o).each(function() {
                        ...
                        if (o.data(n)) {
                            ...
                            d[0] = $.call(this, d[0], "y"),
                            d[1] = $.call(this, d[1], "x"),
                            l.moveDragger && (d[0] *= s.scrollRatio.y,
                            d[1] *= s.scrollRatio.x),
                            l.dur = c,
                            setTimeout(function() {
                                null  !== d[0] && "undefined" != typeof d[0] && "x" !== a.axis && s.overflowed[0] && (l.dir = "y",
                                l.overwrite = "all",
                                Y(o, d[0].toString(), l)),
                                null  !== d[1] && "undefined" != typeof d[1] && "y" !== a.axis && s.overflowed[1] && (l.dir = "x",
                                l.overwrite = "none",
                                Y(o, d[1].toString(), l))
                            }, l.timeout)
                        }
        ...
        , v = function() {
            ...
            m.addClass("mCSB_outside").after(d)) : (m.addClass("mCSB_inside").append(d),
            f.wrap(u)),
            w.call(this);
        ...
        , C = function(e, t, i) {
            ...
            o.removeClass(c[1])) : (e.addClass(c[0]),
            o.addClass(c[1])))
        }
        , T = function() {
            var t = e(this)
        ...
        , k = function() {
            ...
            if (q(t),
            ("x" !== o.axis && !i.overflowed[0] || "y" === o.axis && i.overflowed[0]) && (r[0].add(a).css("top", 0),
            Y(t, "_resetY")),
            "y" !== o.axis && !i.overflowed[1] || "x" === o.axis && i.overflowed[1]) {
                var l = dx = 0;
                "rtl" === i.langDir && (l = s.width() - a.outerWidth(!1),
        ...
        , _ = function() {
            ...
            i.bindEvents && (e(document).unbind("." + s),
            r.each(function() {
                e(this).unbind("." + s)
            }),
        ...
        , E = function(t) {
            ...
            "x" !== s.axis && (o.overflowed[0] && !t ? (l[0].add(d[0]).add(l[0].children("a")).css("display", "block"),
            r.removeClass(c[8] + " " + c[10])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[0].css("display", "none"),
            r.removeClass(c[10])) : (l[0].css("display", "none"),
            r.addClass(c[10])),
            r.addClass(c[8]))),
            "y" !== s.axis && (o.overflowed[1] && !t ? (l[1].add(d[1]).add(l[1].children("a")).css("display", "block"),
            r.removeClass(c[9] + " " + c[11])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[1].css("display", "none"),
        ...
        , M = function() {
            ...
            e(document).bind("mousemove." + h + " pointermove." + h + " MSPointerMove." + h, function(e) {
                ...
                o && (C(o, "active", u.autoExpandScrollbar),
                o = null ),
                d = !1,
        ...
        , P = function() {
            ...
            function o(e) {
                if (J(e) && !d && !I(e)[2] && (e.stopImmediatePropagation(),
                (!C || S) && c)) {
                    g = Q();
                    var t = E.offset()
                      , i = I(e)[0] - t.top
                    ...
                    if (F.push(i),
                    L.push(n),
                    B[2] = Math.abs(I(e)[0] - B[0]),
                    B[3] = Math.abs(I(e)[1] - B[1]),
                    k.overflowed[0])
                        var s = P[0].parent().height() - P[0].height()
                          , a = u - i > 0 && i - u > -(s * k.scrollRatio.y) && (2 * B[3] < B[2] || "yx" === j.axis);
                    if (k.overflowed[1])
                        var r = P[1].parent().width() - P[1].width()
                          , p = h - n > 0 && n - h > -(r * k.scrollRatio.x) && (2 * B[2] < B[3] || "yx" === j.axis);
                    a || p ? (R || e.preventDefault(),
                    S = 1) : (C = 1,
        ...
        , F = function() {
            ...
            h.bind("mousedown." + u, function(e) {
                ...
                if (!t && s && i()) {
                    ...
                    a > 0 && a < p.height() && d > 0 && d < p.width() ? c.step && o("off", null , "stepped") : ("x" !== l.axis && r.overflowed[0] && (0 > a ? o("on", 38) : a > p.height() && o("on", 40)),
                    "y" !== l.axis && r.overflowed[1] && (0 > d ? o("on", 37) : d > p.width() && o("on", 39)))
                }
                ...
                !D(i, t.target)) {
                    ...
                    if ("x" === s.axis || "x" === s.mouseWheel.axis)
                        ...
                        var c = "y"
                          ...
                          , g = t.deltaY || n;
                    "y" === c && !o.overflowed[0] || "x" === c && !o.overflowed[1] || ((s.mouseWheel.invert || t.webkitDirectionInvertedFromDevice) && (g = -g),
                    s.mouseWheel.normalizeDelta && (g = 0 > g ? -1 : 1),
                    (g > 0 && 0 !== m || 0 > g && m !== f || s.mouseWheel.preventDefault) && (t.stopImmediatePropagation(),
                    t.preventDefault()),
                    Y(i, (p - g * h).toString(), {
                        dir: c
                    }))
        ...
        , B = function() {
            ...
            a.bind("focusin." + s, function(i) {
                var n = e(document.activeElement)
                  ...
                  , l = 0;
                n.is(o.advanced.autoScrollOnFocus) && (q(t),
                clearTimeout(t[0]._focusTimeout),
                t[0]._focusTimer = s ? (l + 17) * s : 0,
        ...
        , R = function() {
            function t(t) {
                ...
                case "keyup":
                    ...
                    } else if ((35 === r || 36 === r) && !e(document.activeElement).is(u) && ((o.overflowed[0] || o.overflowed[1]) && (t.preventDefault(),
                    t.stopImmediatePropagation()),
                    "keyup" === t.type)) {
                        if ("x" === s.axis || "yx" === s.axis && o.overflowed[1] && !o.overflowed[0])
                            var p = "x"
        ...
        , H = function(t, i, o, s, a) {
            ...
            switch (i) {
            case "on":
                if (h.dir = [o === c[16] || o === c[15] || 39 === o || 37 === o ? "x" : "y", o === c[13] || o === c[15] || 38 === o || 37 === o ? -1 : 1],
                q(t),
                ee(o) && "stepped" === h.type)
                    return;
                r(m);
        ...
        , $ = function(t, i) {
            if (null  != t && "undefined" != typeof t) {
                ...
                case "number":
                    ...
                    return e(t).length ? "x" === i ? te(e(t))[1] : te(e(t))[0] : (r.css(p, t),
                    void u.update.call(null , o[0]))
                }
            }
        }
        , V = function(t) {
            function i() {
                ...
                0 === r.parents("html").length ? void (r = null ) : void (h[0].autoUpdate = setTimeout(function() {
                    return d.advanced.updateOnSelectorChange && (l.poll.change.n = s(),
                    l.poll.change.n !== l.poll.change.o) ? (l.poll.change.o = l.poll.change.n,
                    void a(3)) : d.advanced.updateOnContentResize && (l.poll.size.n = r[0].scrollHeight + r[0].scrollWidth + h[0].offsetHeight + r[0].offsetHeight,
        ...
        , Y = function(t, i, o) {
            ...
            (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + l.idx + "_scrollbar").css("visibility", "visible"),
            m.scrollTop(0).scrollLeft(0)),
            "_resetY" !== i || l.contentReset.y || (s("onOverflowYNone") && d.callbacks.onOverflowYNone.call(t[0]),
            l.contentReset.y = 1),
            "_resetX" !== i || l.contentReset.x || (s("onOverflowXNone") && d.callbacks.onOverflowXNone.call(t[0]),
            l.contentReset.x = 1),
            "_resetY" !== i && "_resetX" !== i) {
                switch (!l.contentReset.y && t[0].mcs || !l.overflowed[0] || (s("onOverflowY") && d.callbacks.onOverflowY.call(t[0]),
                l.contentReset.x = null ),
                !l.contentReset.x && t[0].mcs || !l.overflowed[1] || (s("onOverflowX") && d.callbacks.onOverflowX.call(t[0]),
                l.contentReset.x = null ),
                d.snapAmount && (i = U(i, d.snapAmount, d.snapOffset)),
                o.dir) {
                case "x":
                ...
                t[0].mcs || (r(),
                s("onInit") && d.callbacks.onInit.call(t[0])),
                clearTimeout(p[0].onCompleteTimeout),
                (l.tweenRunning || !(0 === b && x[0] >= 0 || b === w[0] && x[0] <= w[0])) && (X(v[0], y, Math.round(x[1]), u[1], o.scrollEasing),
                X(p[0], y, Math.round(x[0]), u[0], o.scrollEasing, o.overwrite, {
                    onStart: function() {
                        o.callbacks && o.onStart && !l.tweenRunning && (s("onScrollStart") && (r(),
                    ...
                    onUpdate: function() {
                        o.callbacks && o.onUpdate && s("whileScrolling") && (r(),
                    ...
                    onComplete: function() {
                        if (o.callbacks && o.onComplete) {
                            ...
                            p[0].onCompleteTimeout = setTimeout(function() {
                                ...
                                s("onTotalScroll") && x[1] >= w[1] - k && l.cbOffsets[0] && (r(),
                                d.callbacks.onTotalScroll.call(t[0])),
                                s("onTotalScrollBack") && x[1] <= j && l.cbOffsets[1] && (r(),
        ...
        , X = function(e, t, i, n, o, s, a) {
            function r() {
                ...
                y = Q() - v,
                l(),
                y >= x.time && (x.time = y > x.time ? y + h - (y - x.time) : y + h - 1,
                x.time < y + 1 && (x.time = y + 1)),
                x.time < n ? x.id = p(r) : g.call())
            }
            function l() {
                n > 0 ? (x.currVal = u(x.time, b, S, n, o),
                w[t] = Math.round(x.currVal) + "px") : w[t] = i + "px",
                f.call()
            }
            function d() {
                h = 1e3 / 60,
        ...
        e(window).load(function() {
            ...
            e.extend(e.expr[":"], {
                mcsInView: e.expr[":"].mcsInView || function(t) {
                    ...
                    return s.length ? (i = s.parent(),
                    n = [s[0].offsetTop, s[0].offsetLeft],
                    n[0] + te(o)[0] >= 0 && n[0] + te(o)[0] < i.height() - o.outerHeight(!1) && n[1] + te(o)[1] >= 0 && n[1] + te(o)[1] < i.width() - o.outerWidth(!1)) : void 0
                }
                ,
...
mejs.Utility = {
    ...
    getScriptPath: function(e) {
        for (var t, i, n, o, s, a, r = 0, l = "", d = "", c = document.getElementsByTagName("script"), u = c.length, h = e.length; u > r; r++) {
            for (o = c[r].src,
            i = o.lastIndexOf("/"),
            i > -1 ? (a = o.substring(i + 1),
            s = o.substring(0, i + 1)) : (a = o,
            s = ""),
            t = 0; h > t; t++)
                if (d = e[t],
                n = a.indexOf(d),
    ...
    secondsToTimeCode: function(e, t) {
        ...
        len = lis.length; i < len; i++)
            d = d.replace(lis[i][1] + lis[i][1], this.twoDigitsString(lis[i][0])),
    ...
    detectPlugin: function(e, t, i, n) {
        ...
        if ("undefined" != typeof this.nav.plugins && "object" == typeof this.nav.plugins[e]) {
            ...
            o && ("undefined" == typeof this.nav.mimeTypes || !this.nav.mimeTypes[t] || this.nav.mimeTypes[t].enabledPlugin))
                for (r = o.replace(e, "").replace(/^\s+/, "").replace(/\sr/gi, ".").split("."),
                s = 0; s < r.length; s++)
                    r[s] = parseInt(r[s].match(/\d+/), 10)
...
mejs.MediaFeatures = {
    init: function() {
        ...
        i.hasSemiNativeFullScreen && s.match(/mac os x 10_5/i) && (i.hasNativeFullScreen = !1,
...
mejs.HtmlMediaElementShim = {
    create: function(e, t) {
        ...
        for (n in mejs.MediaElementDefaults)
            o[n] = mejs.MediaElementDefaults[n];
        for (n in t)
            o[n] = t[n];
        ...
        "native" == i.method ? (mejs.MediaFeatures.isBustedAndroid && (s.src = i.url,
        s.addEventListener("click", function() {
            s.play()
        }, !1)),
        this.updateNative(i, o, c, u)) : "" !== i.method ? this.createPlugin(i, o, d, c, u, h) : (this.createErrorMessage(i, o, d),
        this)
    },
    determinePlayback: function(e, t, i, n, o) {
        ...
        if ("undefined" != typeof t.type && "" !== t.type)
            ...
            for (s = 0; s < e.childNodes.length; s++)
                d = e.childNodes[s],
                1 == d.nodeType && "source" == d.tagName.toLowerCase() && (o = d.getAttribute("src"),
                c = this.formatType(o, d.getAttribute("type")),
                f = d.getAttribute("media"),
                (!f || !window.matchMedia || window.matchMedia && window.matchMedia(f).matches) && g.push({
                    type: c,
                    url: o
                }));
        ...
        i && ("auto" === t.mode || "auto_plugin" === t.mode || "native" === t.mode) && (!mejs.MediaFeatures.isBustedNativeHTTPS || t.httpsBasicAuthSite !== !0)) {
            for (n || (m = document.createElement(v.isVideo ? "video" : "audio"),
            e.parentNode.insertBefore(m, e),
            e.style.display = "none",
            v.htmlMediaElement = e = m),
            s = 0; s < g.length; s++)
        ...
        if ("auto" === t.mode || "auto_plugin" === t.mode || "shim" === t.mode)
            for (s = 0; s < g.length; s++)
                ...
                a = 0; a < t.plugins.length; a++)
                    ...
                    r = 0; r < h.length; r++)
                        if (p = h[r],
                        null  == p.version || mejs.PluginDetector.hasPluginVersion(u, p.version))
    ...
    createErrorMessage: function(e, t, i) {
        ...
        s += "<span>" + mejs.i18n.t("Download File") + "</span></a>"),
        o.innerHTML = s,
    ...
    createPlugin: function(e, t, i, n, o, s) {
        ...
        switch (e.isVideo ? (c = t.pluginWidth > 0 ? t.pluginWidth : t.videoWidth > 0 ? t.videoWidth : null  !== d.getAttribute("width") ? d.getAttribute("width") : t.defaultVideoWidth,
        u = t.pluginHeight > 0 ? t.pluginHeight : t.videoHeight > 0 ? t.videoHeight : null  !== d.getAttribute("height") ? d.getAttribute("height") : t.defaultVideoHeight,
        c = mejs.Utility.encodeUrl(c),
        u = mejs.Utility.encodeUrl(u)) : t.enablePluginDebug && (c = 320,
        u = 240),
        p.success = t.success,
        mejs.MediaPluginBridge.registerPluginElement(h, p, d),
        m.className = "me-plugin",
        m.id = h + "_container",
        e.isVideo ? d.parentNode.insertBefore(m, d) : document.body.insertBefore(m, document.body.childNodes[0]),
        l = ["id=" + h, "jsinitfunction=mejs.MediaPluginBridge.initPlugin", "jscallbackfunction=mejs.MediaPluginBridge.fireEvent", "isvideo=" + (e.isVideo ? "true" : "false"), "autoplay=" + (n ? "true" : "false"), "preload=" + o, "width=" + c, "startvolume=" + t.startVolume, "timerrate=" + t.timerRate, "flashstreamer=" + t.flashStreamer, "height=" + u, "pseudostreamstart=" + t.pseudoStreamingStartQueryParam],
        ...
        case "youtube":
            var v;
            -1 != e.url.lastIndexOf("youtu.be") ? (v = e.url.substr(e.url.lastIndexOf("/") + 1),
            -1 != v.indexOf("?") && (v = v.substr(0, v.indexOf("?")))) : v = e.url.substr(e.url.lastIndexOf("=") + 1),
            youtubeSettings = {
                container: m,
                containerId: m.id,
        ...
        case "vimeo":
            ...
            m.innerHTML = '<iframe src="//player.vimeo.com/video/' + p.vimeoid + "?api=1&portrait=0&byline=0&title=0&player_id=" + y + '" width="' + c + '" height="' + u + '" frameborder="0" class="mejs-shim" id="' + y + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
            "function" == typeof $f) {
                ...
                b.addEvent("ready", function() {
                    function e(e, t, i, n) {
                        ...
                        "timeupdate" == i && (t.currentTime = o.currentTime = n.seconds,
                        t.duration = o.duration = n.duration),
                        t.dispatchEvent(o)
                    }
    ...
    updateNative: function(e, t, i, n) {
        ...
        for (o in mejs.HtmlMediaElement)
            s[o] = mejs.HtmlMediaElement[o];
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        meReady: function(t, i) {
            ...
            if (!s.created) {
                ...
                s.media = t,
                s.domNode = i,
                !(a.isAndroid && s.options.AndroidUseNativeControls || a.isiPad && s.options.iPadUseNativeControls || a.isiPhone && s.options.iPhoneUseNativeControls)) {
                    ...
                    ,
                    s.media.addEventListener("click", s.clickToPlayPauseCallback, !1),
                    s.container.bind("mouseenter", function() {
                        s.controlsEnabled && (s.options.alwaysShowControls || (s.killControlsTimer("enter"),
                        s.showControls(),
                        s.startControlsTimer(2500)))
                    }).bind("mousemove", function() {
                        s.controlsEnabled && (s.controlsAreVisible || s.showControls(),
                        s.options.alwaysShowControls || s.startControlsTimer(2500))
                    }).bind("mouseleave", function() {
                        s.controlsEnabled && (s.media.paused || s.options.alwaysShowControls || s.startControlsTimer(1e3))
                    })),
                    s.options.hideVideoControlsOnLoad && s.hideControls(!1),
                    l && !s.options.alwaysShowControls && s.hideControls(),
                    s.options.enableAutosize && s.media.addEventListener("loadedmetadata", function(e) {
                        s.options.videoHeight <= 0 && null  === s.domNode.getAttribute("height") && !isNaN(e.target.videoHeight) && (s.setPlayerSize(e.target.videoWidth, e.target.videoHeight),
                        s.setControlsSize(),
                        s.media.setVideoSize(e.target.videoWidth, e.target.videoHeight))
                    }, !1)),
                    ...
                    s.media.addEventListener("ended", function(t) {
                        if (s.options.autoRewind)
                            try {
                    ...
                    s.media.addEventListener("loadedmetadata", function(e) {
                        s.updateDuration && s.updateDuration(),
                        s.updateCurrent && s.updateCurrent(),
                        s.isFullScreen || (s.setPlayerSize(s.width, s.height),
                        s.setControlsSize())
                    }, !1);
                    var c = null ;
                    s.media.addEventListener("timeupdate", function() {
                        c !== this.duration && (c = this.duration,
                        mejs.Utility.calculateTimeFormat(c, s.options, s.options.framesPerSecond || 25))
                    }, !1),
                    s.container.focusout(function(t) {
                        if (t.relatedTarget) {
                            var i = e(t.relatedTarget);
                            s.keyboardAction && 0 === i.parents(".mejs-container").length && (s.keyboardAction = !1,
                            s.hideControls(!0))
                        }
                    }),
                    setTimeout(function() {
        ...
        buildprogress: function(t, i, n, o) {
            ...
            var s = this
              ...
              , p = function(e) {
                ...
                o.duration && (i < n.left ? i = n.left : i > s + n.left && (i = s + n.left),
                d = i - n.left,
                r = d / s,
                l = .02 >= r ? 0 : r * o.duration,
                m && l !== o.currentTime && o.setCurrentTime(l),
                mejs.MediaFeatures.hasTouch || (c.css("left", d),
                u.html(mejs.Utility.secondsToTimeCode(l, t.options)),
                c.show()))
            }
              , m = !1
              , f = !1
            ...
            a.bind("mousedown touchstart", function(e) {
                (1 === e.which || 0 === e.which) && (m = !0,
                p(e),
                s.globalBind("mousemove.dur touchmove.dur", function(e) {
                    p(e)
                }),
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        ...
        buildduration: function(t, i, n, o) {
            var s = this;
            i.children().last().find(".mejs-currenttime").length > 0 ? e(s.options.timeAndDurationSeparator + '<span class="mejs-duration">' + mejs.Utility.secondsToTimeCode(s.options.duration, s.options) + "</span>").appendTo(i.find(".mejs-time")) : (i.find(".mejs-currenttime").parent().addClass("mejs-currenttime-container"),
            e('<div class="mejs-time mejs-duration-container"><span class="mejs-duration">' + mejs.Utility.secondsToTimeCode(s.options.duration, s.options) + "</span></div>").appendTo(i)),
        ...
        buildvolume: function(t, i, n, o) {
            if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                ...
                o.addEventListener("volumechange", function(e) {
                    m || (o.muted ? (h(0),
                    r.removeClass("mejs-mute").addClass("mejs-unmute")) : (h(o.volume),
            ...
            if (t.isVideo) {
                ...
                if ("native" === a.media.pluginType || !a.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)
                    ...
                    if (d && !mejs.MediaFeatures.isOpera) {
                        ...
                        c = 0,
                        u = f.length; u > c; c++)
                            m[f[c]] = e('<div class="mejs-fullscreen-hover" />').appendTo(a.container).mouseover(p).hide();
        ...
        buildspeed: function(t, i, n, o) {
            ...
            if ("native" == s.media.pluginType) {
                for (var a = null , r = null , l = null , d = null , c = [], u = !1, h = 0, p = s.options.speeds.length; p > h; h++) {
                    ...
                    m === s.options.defaultSpeed && (u = !0)) : (c.push(m),
                    m.value === s.options.defaultSpeed && (u = !0))
                }
                u || c.push({
                ...
                o.addEventListener("loadedmetadata", function(e) {
        ...
        buildtracks: function(t, i, n, o) {
            if (0 !== t.tracks.length) {
                ...
                if (a.domNode.textTracks)
                    for (s = a.domNode.textTracks.length - 1; s >= 0; s--)
                        a.domNode.textTracks[s].mode = "hidden";
                ...
                t.isLoadingTrack = !1,
                s = 0; s < t.tracks.length; s++)
                    "subtitles" == t.tracks[s].kind && t.addTrackButton(t.tracks[s].srclang, t.tracks[s].label);
                t.loadNextTrack(),
                o.addEventListener("timeupdate", function(e) {
                    t.displayCaptions()
                }, !1),
        ...
        webvtt: {
            ...
            parse: function(t) {
                for (var i, n, o, s = 0, a = mejs.TrackFormatParser.split2(t, /\r?\n/), r = {
                    ...
                    if (i = this.pattern_timecode.exec(a[s]),
                    i && s < a.length) {
                        for (s - 1 >= 0 && "" !== a[s - 1] && (o = a[s - 1]),
                        s++,
                        n = a[s],
                        s++; "" !== a[s] && s < a.length; )
                            n = n + "\n" + a[s],
        ...
        dfxp: {
            parse: function(t) {
                ...
                for (o = 0; o < a.length; o++) {
                    ...
                    if (a.eq(o).attr("begin") && (u.start = mejs.Utility.convertSMPTEtoSeconds(a.eq(o).attr("begin"))),
                    !u.start && a.eq(o - 1).attr("end") && (u.start = mejs.Utility.convertSMPTEtoSeconds(a.eq(o - 1).attr("end"))),
                    a.eq(o).attr("end") && (u.stop = mejs.Utility.convertSMPTEtoSeconds(a.eq(o).attr("end"))),
                    !u.stop && a.eq(o + 1).attr("begin") && (u.stop = mejs.Utility.convertSMPTEtoSeconds(a.eq(o + 1).attr("begin"))),
                    i) {
                        c = "";
                        for (var h in i)
                            c += h + ":" + i[h] + ";"
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildcontextmenu: function(t, i, n, o) {
            ...
            t.container.bind("contextmenu", function(e) {
                return t.isContextMenuEnabled ? (e.preventDefault(),
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildpostroll: function(t, i, n, o) {
            ...
            "undefined" != typeof a && (t.postroll = e('<div class="mejs-postroll-layer mejs-layer"><a class="mejs-postroll-close" onclick="$(this).parent().hide();return false;">' + s.options.postrollCloseText + '</a><div class="mejs-postroll-layer-content"></div></div>').prependTo(n).hide(),
            s.media.addEventListener("ended", function(i) {
                e.ajax({
                    dataType: "html",
                    url: a,
...
function(e, t, i, n) {
    ...
    i.extend(r, {
        ...
        open: function(e, t) {
            ...
            !1 !== r.close(!0)) ? (i.isArray(e) || (e = u(e) ? i(e).get() : [e]),
            i.each(e, function(o, s) {
                ...
                !c && m.isDom && (c = s.data("fancybox-type"),
                c || (c = (c = s.prop("class").match(/fancybox\.(\w+)/)) ? c[1] : null )),
                h(a) && (c || (r.isImage(a) ? c = "image" : r.isSWF(a) ? c = "swf" : "#" === a.charAt(0) ? c = "inline" : h(s) && (c = "html",
                d = s)),
                "ajax" === c && (p = a.split(/\s+/, 2),
                a = p.shift(),
                p = p.shift())),
                d || ("inline" === c ? a ? d = i(h(a) ? a.replace(/.*(?=#[^\s]+$)/, "") : a) : m.isDom && (d = s) : "html" === c ? d = a : !c && !a && m.isDom && (c = "inline",
                d = s)),
                i.extend(m, {
                    href: a,
                    type: c,
        ...
        bindEvents: function() {
            ...
            (e = t.keys) && a.bind("keydown.fb", function(o) {
                ...
                return 27 === s && r.coming ? !1 : void (!o.ctrlKey && !o.altKey && !o.shiftKey && !o.metaKey && (!a || !a.type && !i(a).is("[contenteditable]")) && i.each(e, function(e, a) {
                    return 1 < t.group.length && a[s] !== n ? (r[e](a[s]),
                    o.preventDefault(),
                    !1) : -1 < i.inArray(s, a) ? (r[e](),
                    o.preventDefault(),
                    !1) : void 0
                }))
            }),
            i.fn.mousewheel && t.mouseWheel && r.wrap.bind("mousewheel.fb", function(e, n, o, s) {
                for (var a = i(e.target || null ), l = !1; a.length && !l && !a.is(".fancybox-skin") && !a.is(".fancybox-wrap"); )
                    ...
                    a = i(a).parent();
                0 !== n && !l && 1 < r.group.length && !t.canShrink && (s > 0 || o > 0 ? r.prev(s > 0 ? "down" : "left") : (0 > s || 0 > o) && r.next(0 > s ? "up" : "right"),
                e.preventDefault())
            }))
        },
        ...
        _start: function(e) {
            ...
            !1 === r.trigger("beforeLoad"))
                ...
                o.wrap = i(o.tpl.wrap).addClass("fancybox-" + (c ? "mobile" : "desktop") + " fancybox-type-" + n + " fancybox-tmp " + o.wrapCSS).appendTo(o.parent || "body"),
                i.extend(o, {
        ...
        _afterLoad: function() {
            ...
            a && !1 !== r.isActive)
                if (!1 === r.trigger("afterLoad", a, l))
                    ...
                    case "ajax":
                    case "html":
                        a.selector ? e = i("<div>").html(e).find(a.selector) : u(e) && (e.data("fancybox-placeholder") || e.data("fancybox-placeholder", i('<div class="fancybox-placeholder"></div>').insertAfter(e).hide()),
                        e = e.show().detach(),
        ...
        _setDimension: function() {
            ...
            E = m(y.outerWidth(!0) - y.width()),
            e = m(y.outerHeight(!0) - y.height()),
            t = I + E,
            n = M + e,
            o = p(v) ? (u.w - t) * m(v) / 100 : v,
            s = p(x) ? (u.h - n) * m(x) / 100 : x,
            "iframe" === w.type) {
                if (c = w.content,
                w.autoHeight && 1 === c.data("ready"))
                    try {
                        c[0].contentWindow.document.location && (b.width(o).height(9999),
                        a = c.contents().find("body"),
                        _ && a.css("overflow-x", "hidden"),
                        s = a.outerHeight(!0))
                    } catch (P) {}
            } else
            ...
            a = T,
            l = k,
            w.fitToView && (T = Math.min(u.w - t, T),
            k = Math.min(u.h - n, k)),
            t = u.w - I,
            M = u.h - M,
            w.aspectRatio ? (v > T && (v = T,
            x = m(v / d)),
            x > k && (x = k,
            v = m(x * d)),
            S > v && (v = S,
            x = m(v / d)),
            C > x && (x = C,
            v = m(x * d))) : (v = Math.max(S, Math.min(v, T)),
            w.autoHeight && "iframe" !== w.type && (b.width(v),
            x = b.height()),
            x = Math.max(C, Math.min(x, k))),
            w.fitToView)
                ...
                I = g.height(),
                w.aspectRatio)
                    for (; (u > t || I > M) && v > S && x > C && !(19 < h++); )
                        x = Math.max(C, Math.min(k, x - 10)),
                        v = m(x * d),
                        S > v && (v = S,
                        x = m(v / d)),
                        v > T && (v = T,
    ...
    r.transitions = {
        getOrigPosition: function() {
            ...
            s = i.outerHeight())) : (n.top = d.y + (d.h - s) * e.topRatio,
            n.left = d.x + (d.w - o) * e.leftRatio),
            ("fixed" === r.wrap.css("position") || e.locked) && (n.top -= d.y,
            n.left -= d.x),
            n = {
        ...
        step: function(e, t) {
            ...
            n = e - n,
            r.skin[o](m("width" === o ? n : n - s * i)),
            r.inner[o](m("width" === o ? n : n - s * i - a * i)))
        },
        zoomIn: function() {
            var e = r.current
              , t = e.pos
        ...
        changeIn: function() {
            var e, t = r.current, i = t.nextEffect, n = t.pos, o = {
                opacity: 1
            }, s = r.direction;
            n.opacity = .1,
            "elastic" === i && (e = "down" === s || "up" === s ? "top" : "left",
            "down" === s || "right" === s ? (n[e] = f(m(n[e]) - 200),
            o[e] = "+=200px") : (n[e] = f(m(n[e]) + 200),
            o[e] = "-=200px")),
    ...
    r.helpers.overlay = {
        ...
        update: function() {
            ...
            a.width() > e && (i = a.width())) : a.width() > s.width() && (i = a.width()),
        ...
        onReady: function(e, t) {
            ...
            n || this.create(e),
            e.locked && this.fixed && t.fixed && (n || (this.margin = a.height() > s.height() ? i("html").css("margin-right").replace("px", "") : !1),
    ...
    i.fn.fancybox = function(e) {
        var t, n = i(this), o = this.selector || "", s = function(s) {
            ...
            !s.ctrlKey && !s.altKey && !s.shiftKey && !s.metaKey && !d.is(".fancybox-wrap") && (a = e.groupAttr || "data-fancybox-group",
            l = d.attr(a),
            l || (a = "rel",
            l = d.get(0)[a]),
            l && "" !== l && "nofollow" !== l && (d = o.length ? i(o) : n,
            d = d.filter("[" + a + '="' + l + '"]'),
            c = d.index(this)),
            e.index = c,
            !1 !== r.open(d, e) && s.preventDefault())
        }
        ;
        return e = e || {},
        t = e.index || 0,
...
function(e) {
    ...
    t.helpers.media = {
        ...
        beforeLoad: function(t, n) {
            ...
            for (o in t)
                if (t.hasOwnProperty(o) && (s = t[o],
                a = l.match(s.matcher))) {
                    d = s.type,
                    r = e.extend(!0, {}, s.params, n[o] || (e.isPlainObject(t[o]) ? t[o].params : null )),
...
function(e, t, i) {
    var n = {
        ...
        loadContent: function() {
            function t(e) {
                ...
                if ("function" == typeof n.options.jsonSuccess)
                    ...
                    for (t in e.owl)
                        e.owl.hasOwnProperty(t) && (i += e.owl[t].item);
                    n.$elem.html(i)
                }
                n.logIn()
            }
            ...
            "string" == typeof n.options.jsonPath ? (i = n.options.jsonPath,
            e.getJSON(i, t)) : n.logIn()
        },
        logIn: function() {
        ...
        updateItems: function() {
            ...
            if (t = e(this.options.responsiveBaseWidth).width(),
        ...
        response: function() {
            var i, n, o = this;
            return !0 !== o.options.responsive ? !1 : (n = e(t).width(),
            o.resizer = function() {
                e(t).width() !== n && (!1 !== o.options.autoPlay && t.clearInterval(o.autoPlayInterval),
                t.clearTimeout(i),
        ...
        max: function() {
            ...
            return this.options.items > this.itemsAmount ? this.maximumPixels = e = this.maximumItem = 0 : (this.maximumItem = this.itemsAmount - this.options.items,
        ...
        loops: function() {
            ...
            this.pagesInArray = [],
            t = 0; t < this.itemsAmount; t += 1)
                o += this.itemWidth,
                this.positionsInArray.push(-o),
                !0 === this.options.scrollPerPage && (i = e(this.$owlItems[t]),
                i = i.data("owl-roundPages"),
                i !== n && (this.pagesInArray[n] = this.positionsInArray[t],
                n = i))
        },
        ...
        goTo: function(e, i, n) {
            ...
            o.transition3d(e)) : !0 === i ? o.css2slide(e, o.options.paginationSpeed) : "rewind" === i ? o.css2slide(e, o.options.rewindSpeed) : o.css2slide(e, o.options.slideSpeed),
            void o.afterGo()))
        },
        jumpTo: function(e) {
        ...
        play: function() {
            ...
            !1 === e.options.autoPlay ? !1 : (t.clearInterval(e.autoPlayInterval),
        ...
        gestures: function() {
            ...
            function o(t) {
                "on" === t ? (e(i).on(r.ev_types.move, s),
                e(i).on(r.ev_types.end, a)) : "off" === t && (e(i).off(r.ev_types.move),
                e(i).off(r.ev_types.end))
            }
            function s(o) {
            ...
            function a(i) {
                ...
                0 !== r.newRelativeX && (n = r.getNewPosition(),
                r.goTo(n, !1, "drag"),
                l.targetElement === i.target && !0 !== r.browser.isTouch && (e(i.target).on("click.disable", function(t) {
                    t.stopImmediatePropagation(),
                    t.stopPropagation(),
                    t.preventDefault(),
                    e(t.target).off("click.disable")
                }),
                i = e._data(i.target, "events").click,
                n = i.pop(),
                i.splice(0, 0, n))),
                o("off")
            }
        ...
        closestItem: function() {
            ...
            return e.each(i, function(s, a) {
                n - t.itemWidth / 20 > i[s + 1] && n - t.itemWidth / 20 < a && "left" === t.moveDirection() ? (o = a,
                t.currentItem = !0 === t.options.scrollPerPage ? e.inArray(o, t.positionsInArray) : s) : n + t.itemWidth / 20 < a && n + t.itemWidth / 20 > (i[s + 1] || i[s] - t.itemWidth) && "right" === t.moveDirection() && (!0 === t.options.scrollPerPage ? (o = i[s + 1] || i[i.length - 1],
                t.currentItem = e.inArray(o, t.positionsInArray)) : (o = i[s + 1],
                t.currentItem = s + 1))
            }),
            t.currentItem
        },
        moveDirection: function() {
            var e;
            return 0 > this.newRelativeX ? (e = "right",
            this.playDirection = "next") : (e = "left",
        ...
        lazyLoad: function() {
            ...
            for (t = 0; t < this.itemsAmount; t += 1)
                i = e(this.$owlItems[t]),
                "loaded" !== i.data("owl-loaded") && (n = i.data("owl-item"),
                o = i.find(".lazyOwl"),
                "string" != typeof o.data("src") ? i.data("owl-loaded", "loaded") : (void 0 === i.data("owl-loaded") && (o.hide(),
                i.addClass("loading").data("owl-loaded", "checked")),
                (s = !0 === this.options.lazyFollow ? n >= this.currentItem : !0) && n < this.currentItem + this.options.items && o.length && this.lazyPreload(i, o)))
        },
        ...
        onVisibleItems: function() {
            ...
            this.visibleItems = [],
            t = this.currentItem; t < this.currentItem + this.options.items; t += 1)
        ...
        addItem: function(e, t) {
            var i;
            return e ? 0 === this.$elem.children().length ? (this.$elem.append(e),
            this.setVars(),
            !1) : (this.unWrap(),
            i = void 0 === t || -1 === t ? -1 : t,
            i >= this.$userItems.length || -1 === i ? this.$userItems.eq(-1).after(e) : this.$userItems.eq(i).before(e),
            void this.setVars()) : !1
        },
        removeItem: function(e) {
            return 0 === this.$elem.children().length ? !1 : (e = void 0 === e || -1 === e ? -1 : e,
            this.unWrap(),
...
!function(e) {
    ...
    e(function() {
        ...
        a.click(function() {
            ...
            e(this).removeClass("opened")) : (e(this).parent().animate({
                left: "0px"
            }, 500),
        ...
        e(".op-theme-headimg button").click(function() {
            e("body").hasClass("header-has-img") ? (e(this).removeClass("active"),
            e("body").removeClass("header-has-img")) : (e(this).addClass("active"),
            e("body").addClass("header-has-img"))
        })
    })
}(jQuery),
function(e) {
    ...
    function t() {
        ...
        L || (t.appear(),
        t.on("appear", function(t, i) {
            for (var n = 0; n < i.length; n++)
                e(i[n]).addClass("animated")
        }),
        e.force_appear())
    }
    function i() {
    ...
    function l() {
        e(window).width() > 600 ? e(".timeline").each(function() {
            for (var t = 25, i = 0, n = 70, o = 0, s = 0, a = 0, r = 0, l = e(this).find(".timeline-bar"), d = e(this).find(".timeline-inner"), c = e(this).find(".timeline-box-left"), u = e(this).find(".timeline-box-right"), h = 0; h < c.length; h++)
                e(c[h]).css({
                    position: "absolute",
                    left: "0",
                    top: i + "px"
        ...
        }) : (e(".timeline-bar").attr("style", ""),
        e(".timeline-box").attr("style", ""),
        e(".timeline-inner").attr("style", ""))
    }
    function d() {
        return 42
    }
    function c() {
        ...
        t.length > 0 && (z = {
            ...
            initWeekNames: function() {
                ...
                for (var e = "<tr>", t = 0; t < this.weekNames.length; ++t)
                    e += "<th>" + this.weekNames[t].substring(0, 3) + "</th>";
                e += "</tr>",
                i.append(e)
            },
            ...
            createMonthHtml: function(e, t) {
                ...
                l.empty().html(e);
                for (var a = 0; a < this.busyDays.length; a++)
                    this.busyDays[a].getFullYear() == e && this.busyDays[a].getMonth() == t && (s[a] = this.busyDays[a].getDate());
                for (var d = 0; 42 > d; d++) {
                    var c = "";
            ...
            nextMonth: function() {
                this.active.year != this.limitUp.year || this.active.month != this.limitUp.month ? (d.addClass("moveup"),
                n.addClass("moveright"),
                setTimeout(function() {
                ...
                11 == this.active.month ? (this.active.month = 0,
                this.active.year = this.active.year + 1) : this.active.month = this.active.month + 1,
                this.createMonthHtml(this.active.year, this.active.month)) : console.log("Calendar Limit Up")
            },
            prevMonth: function() {
                this.active.year != this.limitDown.year || this.active.month != this.limitDown.month ? (d.addClass("moveup"),
                n.addClass("moveright"),
                setTimeout(function() {
                    d.removeClass("moveup"),
                    d.addClass("movedown"),
                ...
                0 == this.active.month ? (this.active.month = 11,
                this.active.year = this.active.year - 1) : this.active.month = this.active.month - 1,
                this.createMonthHtml(this.active.year, this.active.month)) : console.log("Calendar Limit Down")
            }
        },
        z.active.year = z.currentYear,
        z.active.month = z.currentMonth,
        z.limitUp.year = z.currentYear + 1,
        z.limitUp.month = z.currentMonth,
        z.limitDown.year = z.currentYear,
        z.limitDown.month = z.currentMonth,
        z.weekStart = t.data("weekstart"),
        z.busyDays = B,
        z.init(),
        t.on(A, ".calendar-prev", function() {
            z.prevMonth()
        }),
    ...
    function f(e, t) {
        ...
        H = 0; H < e.length; H++)
            "##" == e[H] ? O += " " : "$$" == e[H] ? O += "\n" : (R = parseInt(e[H]) - t,
            O += 32 == R ? "://" : 33 == R ? "." : 34 == R ? "-" : 35 == R ? "!" : 36 == R ? "," : W[R]);
        return O
    }
    function g() {
        var t = e(".header");
        e(window).width() > 767 && !L ? (D < P.outerHeight() && (D = P.outerHeight(),
        t.css("min-height", D + "px")),
        e(window).scrollTop() > P.outerHeight() ? P.addClass("head-sticky") : P.removeClass("head-sticky")) : (P.removeClass("head-sticky"),
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (L = !0,
    e("html").addClass("mobile")) : (L = !1,
    ...
    e(window).load(function() {
        ...
        for (var D = e(".input-field input, .input-field textarea"), o = 0; o < D.length; o++)
            e(D[o]).val() ? e(D[o]).parent(".input-field").addClass("used") : e(D[o]).parent(".input-field").removeClass("used");
        D.on("blur", function() {
        ...
        P = e(".head-bar"),
        P.length > 0 && (P.addClass("animated"),
        g(),
        ...
        e(".contact-submit").on("click", function(t) {
            ...
            "" === r.val() && (i = !0,
            r.parent().addClass("error")),
            i || e.post("php/contact_form.php", n.serialize(), function(e) {
                l.html(e)
            }),
            !1
        }),
    ...
    e(window).resize(function() {
        var t = function() {
          ...
          , i = e(window).width()
          , n = e(window).height();
        ($ != i || V != n) && (window.clearTimeout(N),
        N = window.setTimeout(t, 10)),
        $ = i,
        V = n
    })
}(jQuery);
